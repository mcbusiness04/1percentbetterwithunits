...
- **Fixed: Penalty system refactored** - Each bad habit tap removes 10% of total logged units from Today's score (distributed evenly across habits)
...
- **Fixed: % better display** - Shows "1% better" at 100% goal completion (effective), "2% better" at 200%; progress 0-100% before goals met
